 ...
 if ($stmt->num_rows > 0) {
            ...
            <body>
                <div class="error-container">
                    ...
                    <a href="https://readingparadox.com/public_html/baseline.php" class="redirect-button">Go to Main Page Now</a>
                </div>
                <script>
                    let countdown = 10;
                    ...
                    const countdownInterval = setInterval(() => {
                        ...
                        if (countdown <= 0) {
                            ...
                            window.location.href = 'https://readingparadox.com/public_html/baseline.php';
                        }
                    }, 1000);
                </script>
            </body>
    ...
    elseif (isset($_POST['start_reading_task'])) {
           ...
           header("Location: " . $_SERVER['PHP_SELF']);
           exit();
       } elseif (isset($_POST['process_text']) && $_SESSION['study_group'] === 'baseline') {
           $text = $_POST['text'];
...
function logInteraction($prolificId, $group, $actionType, $details) {
    ...
    if ($isNewFile) {
        fputcsv($fp, ['prolific_id', 'group', 'timestamp', 'action_type', 'user_input', 'ai_response']);
    }
...
<!-- Hotjar Tracking Code for Baseline -->
        <script>
            (function(h,o,t,j,a,r){
                h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
                h._hjSettings={hjid:5164348,hjsv:6};
...
.study-chat-container.minimized {
    height: 50px;
}
...
.text-layer .highlight.selected {
      ...
      <div class="container">
         ...
         <ul class="mdc-list mdc-list--dense">
            <li class="mdc-list-item" tabindex="0">
               ...
               <span class="mdc-list-item__text">You will be asked to complete several questionnaires that assess your motivation for reading, awareness of reading strategies, and system usability.</span>
            </li>
            <li class="mdc-list-item" tabindex="0">
      ...
      <div class="container">
         ...
         <div class="tool-demo">
            ...
            <div class="demo-container">
               <img src="baseline.png" alt="Tool Demo" class="demo-image">
               <ol class="mdc-list">
                  ...
                  <li class="mdc-list-item">
                     ...
                     <span class="mdc-list-item__text">Use the AI assistant for clarifications</span>
                  </li>
                  <li class="mdc-list-item">
         ...
         <h2 class="mdc-typography--headline5">AI Assistant</h2>
         <p class="mdc-typography--body1">An AI-powered chat assistant is available to help you understand the text better. You can:</p>
         <ul class="mdc-list">
            <li class="mdc-list-item">
            ...
            <li class="mdc-list-item">
               ...
               <span class="mdc-list-item__text">Request clarifications on complex terms or concepts</span>
            </li>
            <li class="mdc-list-item">
               <span class="mdc-list-item__graphic material-icons">short_text</span>
               <span class="mdc-list-item__text">Get summaries of specific sections</span>
            </li>
         </ul>
         ...
         <p class="mdc-typography--body1 important-note">Remember, the AI assistant is there to help you understand the text, not to provide answers to the study questions. You must answer all questions before proceeding to the next task.</p>
         <form method="POST">
 ...
 #study-task-navigation button:disabled:hover::after {
          content: 'Please complete this task to proceed';
          position: absolute;
          background-color: var(--dark-blue);
          color: #ffffff;
          padding: 5px;
...
document.addEventListener('DOMContentLoaded', IntelligentStudyMonitor.init);
    ...
    chatHeader.className = 'study-chat-header';
    chatHeader.innerHTML = '<span>AI Reading Assistant</span><span class="toggle-btn">+</span>';
   ...
   function toggleChat() {
        ...
        const toggleBtn = chatHeader.querySelector('.toggle-btn');
        toggleBtn.textContent = chatContainer.classList.contains('expanded') ? '-' : '+';
    }
...
async function renderPdf(pdf) {
    ...
    for (let pageNum = 1; pageNum <= pdf.numPages; pageNum++) {
        renderPromises.push((async () => {
            ...
            pageDiv.style.height = `${originalViewport.height * SCALE}px`;
        ...
        if (e.key === 'Enter') {
         ...
         function showResults() {
             ...
             completeStudyBtn.addEventListener('click', function() {
                 ...
                 window.location.href = 'https://ww2.unipark.de/uc/iuiba/';
             });
            ...
            nextTaskBtn.addEventListener('click', function(event) {
                if (!timeElapsed || !allQuestionsAnswered) {
                    ...
                    if (!timeElapsed && !allQuestionsAnswered) {
                        ...
                        showNotification('Please answer all questions before proceeding and wait for the timer to elapse.', 'warning');
                    }
                } else {
...
(function() {
 ...
 document.addEventListener('DOMContentLoaded', function () {
    ...
    if (document.querySelector('.study-container')) {
        ...
        const addStep = (id, title, text, element, position) => {
            tour.addStep({
                id: id,
                title: title,
                text: text,
        ...
        addStep('welcome', 'Welcome', 'Welcome to the Reading Comprehension Study. Let\'s explore the main features.', '.study-main-content', 'bottom');
        addStep('task-info', 'Task Progress', 'Here you can see your current task progress and timer.', '#study-task-info', 'right');
        addStep('chat-assistant', 'Chat Assistant', 'Use this chat to ask questions about the content you\'re reading.', '.study-chat-container', 'top');
        addStep('navigation', 'Navigation', 'Use these buttons to navigate between tasks.', '#study-task-navigation', 'top');
        addStep('floating-menu', 'Zoom and Fullscreen', 'These buttons allow you to zoom in/out and toggle fullscreen mode.', '.study-floating-menu', 'left');
